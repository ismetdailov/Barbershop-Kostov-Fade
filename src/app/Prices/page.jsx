...
const Prices = () => {
  const prices = [
    ...
    { service: "Оформяне на БРАДА + стилизиране", price: "19.50 лв / 10 €" },
    { service: "Детско подстригване", price: "19.50 лв / 10 €" },
    ...
    { service:["VIP ПОДСТРИЖКА  Детайлно подстригване + стилизиране кална маска и масаж на врата"], price: "48.90 лв / 25 €" },
    { service:["VIP ПОДСТРИЖКА И ОФОРМЯНЕ НА БРАДА  Детайлно подстригване + Оформяне на БРАДА + стилизиране кална маска и масаж на врата"], price: "68.45 лв / 35 €" },
