...
const Prices = () => {
  const prices = [
    { service: "Детайлно подстригване + стилизиране", price: "25.43лв/ 13 € " },
    { service: "Детайлно подстригване и оформяне на брада + стилизиране", price: "39.12 лв / 20 €" },
    ...
    { service: "Кола маска/кална маска с бръснач", price: "9.78 лв / 5 €" },
  ];
  // const Prices = () => {
  // const prices = [
